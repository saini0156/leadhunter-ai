...
ALLOWED: Dict[str, FrozenSet[str]] = {
    ...
    S.VERIFIED.value: frozenset({S.QUALIFIED.value, S.PENDING_APPROVAL.value, S.FAILED.value, S.DISCARDED.value, S.DO_NOT_CONTACT.value, S.DUPLICATE.value}),
    S.QUALIFIED.value: frozenset({S.SCORED.value, S.PERSONALIZED.value, S.PENDING_APPROVAL.value, S.FAILED.value, S.DISCARDED.value, S.DO_NOT_CONTACT.value, S.DUPLICATE.value}),
    S.SCORED.value: frozenset({S.PERSONALIZED.value, S.DEMO_READY.value, S.PENDING_APPROVAL.value, S.FAILED.value, S.DISCARDED.value, S.DO_NOT_CONTACT.value, S.DUPLICATE.value}),
    S.PERSONALIZED.value: frozenset({S.DEMO_READY.value, S.PENDING_APPROVAL.value, S.FAILED.value, S.DO_NOT_CONTACT.value, S.DUPLICATE.value}),
